...
async def privacy_policy_page():
    ...
    return _page(
        ...
        "tarih, saat ve kalori bilgileri atanmış diyetisyenin paneline ve "
        "kullanıcının seçtiği e-posta/SMS kanallarına gönderilir. E-posta ve "
        "SMS hizmet sağlayıcıları bu iletim sırasında alıcı iletişim bilgisini "
        "ve onaylanan rapor içeriğini işler. Etkin sağlayıcıların ülkesi, alt "
