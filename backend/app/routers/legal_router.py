...
async def privacy_policy_page():
    ...
    return _page(
        ...
        "<p>Kullanıcının her rapor için ayrı onay verdiği besin adı, miktar, "
        "tarih, saat ve kalori bilgileri yalnız atanmış diyetisyenin giriş "
        "korumalı panelinde gösterilir. E-posta ve SMS sağlayıcıları yalnız "
        "alıcının iletişim bilgisini ve sağlık ayrıntısı içermeyen yeni rapor "
        "bildirimini işler; besin adı, miktar, tarih, saat ve kalori bu "
        "kanallara gönderilmez. Etkin sağlayıcıların ülkesi, alt "
        "işleyenleri ve KVKK m.9 "
