...
| İlaç ve takviye listesi | Kullanıcının kendi hatırlatması ve günlük takibi | Yalnız cihazda, şifreli depoda (`flutter_secure_storage`); sunucuya gönderilmez | Sağlık verisi; KVKK m.6 özel nitelikli | Kullanıcı listeden silebilir; uygulama kaldırılınca cihazdan gider |
