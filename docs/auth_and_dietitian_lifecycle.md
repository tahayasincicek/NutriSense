...
Test hesabı uygulamadaki **Hesap Oluştur** ekranından, yalnız gerçek ad ve `example.com` e-posta adresiyle oluşturulur. Diyetisyen testi için veritabanına gerçek, `email_verified=true` bir sandbox kaydı fixture/migration ile eklenmelidir; production doğrulaması taklit edilmemelidir.
