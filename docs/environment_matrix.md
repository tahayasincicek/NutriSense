...
| Veritabanı | geliştirici MySQL; hızlı unit test için SQLite | izole SQLite ve migration testleri; Compose smoke için MySQL | ayrı MySQL, yalnız gerçek veri | yönetilen/harici MySQL, yedek ve PITR gerekli |
...
Aşağıdakiler bilinmediği için ONAYLANDI ile aşılmaz:
