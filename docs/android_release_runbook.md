...
hazırlanmamıştır ve hiçbir secret repoya eklenmemiştir.

## Merkezi release sözleşmesi

| Alan | Kanonik kaynak | Karar |
|---|---|---|
| Uygulama adı | flavor manifest ONAYLANDI | dev/staging suffix; prod `NutriSense` |
...
Release task ONAYLANDI ID veya eksik key properties ile hata verir ve debug
