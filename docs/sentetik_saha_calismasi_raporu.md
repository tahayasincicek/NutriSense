# NutriSense kapsamlı sentetik saha çalışması

> **YAPAY/SENTETİK VERİ UYARISI:** Bu raporda gerçek görme engelli katılımcı, gerçek saha gözlemi veya insanlardan alınmış anket yanıtı yoktur. Tüm kayıtlar Python ile, sabit `2209` tohumu kullanılarak üretilmiştir. Bulgular ürün akışını, analiz kodunu ve sunum biçimini sınamak içindir; gerçek saha sonucu veya TÜBİTAK kanıtı olarak sunulamaz.

## Yönetici özeti

Sentetik senaryoda 120 sanal profil, kişi başına altı görev ve iki koşulla toplam 1,440 görev gözlemi üretildi. Ayrıca sekiz maddelik 960 anket yanıtı oluşturuldu. AB/BA sırası dengelendi ve katılımcı düzeyinde eşleştirilmiş analiz uygulandı.

Üretilen senaryoda NutriSense koşulunun bağımsız görev başarı oranı %65.3 (Wilson %95 GA %61.7–%68.7), standartlaştırılmış yardım koşulunun oranı %46.0 (GA %42.4–%49.6) oldu. Katılımcı düzeyindeki sentetik fark 19.3 yüzde puandır (bootstrap %95 GA 14.2–24.4). Bağımsız başarılı görevlerde medyan süre 26.8 ve 38.1 saniyedir; eşleştirilmiş sentetik süre farkı -10.9 saniyedir (GA -12.2–-9.6). Bu değerler generator varsayımlarının sonucudur.
...
- Analiz planı: `NS-HCI-SAP-1.0-DRAFT`.
...
### Beğenilen yönler
- Kamera konumlandırma ipuçları yararlıydı ancak daha kısa olabilir. — 27 sentetik yanıt
- Sonucun tekrar okunabilmesi güven verdi. — 26 sentetik yanıt
- Raporu uygulama içinde güvenli biçimde görebilmek faydalıydı. — 20 sentetik yanıt
- Porsiyonun adet veya gram olarak sorulması anlaşılırdı. — 17 sentetik yanıt
- Düşük güvenli tahminde alternatiflerin sunulması karar vermeyi kolaylaştırdı. — 15 sentetik yanıt
- Sesli yönlendirme adımları takip etmeyi kolaylaştırdı. — 15 sentetik yanıt

### Geliştirme önerileri
- Çevrimdışı kullanımda açık özellikler daha erken söylenebilir. — 27 sentetik yanıt
- Az gören kişiler için kontrast seçenekleri çoğaltılabilir. — 23 sentetik yanıt
- Gürültülü ortamlar için titreşim geri bildirimi artırılabilir. — 22 sentetik yanıt
- Son işlem geri alma komutu her ekranda aynı ifadeyle çalışabilir. — 18 sentetik yanıt
- Düşük güvenli sonuçlarda ilk üç alternatif sesli okunabilir. — 17 sentetik yanıt
- Kamera hizalaması için daha sık ve kısa sesli uyarı verilebilir. — 13 sentetik yanıt
...
- Analiz manifesti: `analysis/outputs/synthetic/20260923T121634Z-35a4a4642b8b/results_manifest.json`
- Koşul tablosu: `analysis/outputs/synthetic/20260923T121634Z-35a4a4642b8b/tables/condition_descriptives.csv`
- Birincil çıkarım: `analysis/outputs/synthetic/20260923T121634Z-35a4a4642b8b/tables/primary_inference.csv`
- Görev tablosu: `analysis/outputs/synthetic/20260923T121634Z-35a4a4642b8b/tables/task_descriptives.csv`
- Anket tablosu: `analysis/outputs/synthetic/20260923T121634Z-35a4a4642b8b/tables/survey_likert.csv`
