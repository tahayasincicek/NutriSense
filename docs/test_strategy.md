...
katılımcı kanıtından ayırır. gerçek fixture başarısı saha çalışması, model
...
- Android integration: `integration_test/p0_fixture_journey_test.dart`, gerçek
  kamera/sağlayıcı yerine gerçek transport kullanarak oturum -> karar ->
...
3. Android API 35 emulator gerçek P0 integration testi.
