...
|---|---|---|---:|---|---|
| P0-01 | Doğrulanmamış araştırma sayılarını kaynak taslaklarda karantinaya al | Bu audit ve danışman onayı | 0,5 | n=20, %90, p<0,001, d=2,84 gibi değerlerin gerçek sonuç diye sunulması | `tubitak_sonuc_raporu.md` ve `akademik_makale_taslak.md` başında görünür “DOĞRULANMAMIŞ TASLAK — RAPORDA KULLANILMAMALI” bandı; her ampirik tablo bu register ID’lerine bağlı; veri gelmeden yeni sayı üretilmiyor. |
...
| P1-10 | iOS platformunu ve VoiceOver akışını ekle veya resmi kapsam değişikliği yap | P0-05, P0-06, P0-07 | 5–12 | PDF taahhüdü ve “tamamlandı” iddiasının karşılanmaması | Seçenek A: iOS projesi, izinler, signing, gerçek cihaz VoiceOver, IPA/TestFlight ve CI. Seçenek B: danışman/onay veren kurumca gerekçeli kapsam değişikliği ve tüm raporlarda düzeltme. |
...
4. **Platform kararı:** iOS gerçekleştirilecek mi, yoksa TÜBİTAK kapsam değişikliği mi istenecek?
