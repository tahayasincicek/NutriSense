...
3. gerçek hesap, test yiyeceği, sandbox diyetisyen ve ağ/offline senaryosunu hazırla.
...
6. Gerçek katılımcı gelmeden deneme verisini sil; gerçek fixture'ı sonuç analizi dışında tut.
