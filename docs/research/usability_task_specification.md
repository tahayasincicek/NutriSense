...
**Sürüm:** NS-USABILITY-1.0-FINAL. Kurul onayı öncesi yalnız gerçek pilotta kullanılabilir.
...
|---|---|---|---|---|---:|
| t1 | Giriş | Uygulama kapalı | Ana sayfa başlığı duyulur | Doğru gerçek hesapla ana sayfaya ulaşır | 180 sn |
...
| t4 | Rapor | gerçek doğrulanmış diyetisyen/geçmiş | Önizleme, alıcı, kanal doğrulanıp sandbox sonucu alınır | Açık onaydan önce göndermez | 300 sn |
...
Monotonik süre kanoniktir. Sayaç arızasında `timing_source=manual`, `manually_edited=true`, zorunlu `edit_reason` kullanılır. Tahmini süre hazırlanmaz; güvenilir başlangıç/bitiş yoksa süre null ve `technical_failure` olur.
