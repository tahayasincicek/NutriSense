...
- Koşullar arasında kısa mola ve farklı fakat eşdeğer gerçek besin senaryosu kullanılır.
...
Sessiz, erişilebilir, özel bir oda; katılımcının kendi kulaklığına izin; kişisel bildirimler kapalı; gerçek test hesabı ve kişisel veri içermeyen test yiyecekleri kullanılır. Planlanan toplam süre yaklaşık 50–70 dakikadır; kesin süre pilot sonrası etik kurul değişiklik prosedürüyle güncellenir.
...
1. Kurul onaylı küçük gerçek/pilot süreçle görev anlaşılabilirliği ve ölçüm varyansı değerlendirilir; pilot ana analize katılacaksa önceden belirtilir.
...
Boş veya eksik değer kapıyı açmaz.
