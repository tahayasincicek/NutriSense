...
| gerçek fixture | test UUID ve örnek yanıt | geliştiriciler | sonuç analizine alınmaz |

Kesin saklama süreleri hazırlanmaz. Veri sorumlusu, hukuki dayanak, amaç ve kurul kararıyla her sınıf için süreyi **[doldurmalıdır]**. “2 yıl” varsayılan değildir.
...
| survey_version | string | `NS-SURVEY-1.0-FINAL` kurul öncesi |
...
- gerçek kayıtlar `data_origin=synthetic`; araştırma istatistiği endpointine girmez.
