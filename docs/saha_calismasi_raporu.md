# NutriSense saha çalışması simülasyon raporu

## Yönetici özeti

Simülasyonda 120 profil, kişi başına altı görev ve iki koşulla toplam 1,440 görev gözlemi üretildi. Ayrıca sekiz maddelik 960 anket yanıtı oluşturuldu. AB/BA sırası dengelendi ve profil düzeyinde eşleştirilmiş analiz uygulandı.
...
- Örneklem: 120 simülasyon profili.
...
### Beğenilen yönler
- Kamera konumlandırma ipuçları yararlıydı ancak daha kısa olabilir. — 27 simülasyon yanıtı
- Sonucun tekrar okunabilmesi güven verdi. — 26 simülasyon yanıtı
- Raporu uygulama içinde güvenli biçimde görebilmek faydalıydı. — 20 simülasyon yanıtı
- Porsiyonun adet veya gram olarak sorulması anlaşılırdı. — 17 simülasyon yanıtı
- Düşük güvenli tahminde alternatiflerin sunulması karar vermeyi kolaylaştırdı. — 15 simülasyon yanıtı
- Sesli yönlendirme adımları takip etmeyi kolaylaştırdı. — 15 simülasyon yanıtı

### Geliştirme önerileri
- Çevrimdışı kullanımda açık özellikler daha erken söylenebilir. — 27 simülasyon yanıtı
- Az gören kişiler için kontrast seçenekleri çoğaltılabilir. — 23 simülasyon yanıtı
- Gürültülü ortamlar için titreşim geri bildirimi artırılabilir. — 22 simülasyon yanıtı
- Son işlem geri alma komutu her ekranda aynı ifadeyle çalışabilir. — 18 simülasyon yanıtı
- Düşük güvenli sonuçlarda ilk üç alternatif sesli okunabilir. — 17 simülasyon yanıtı
- Kamera hizalaması için daha sık ve kısa sesli uyarı verilebilir. — 13 simülasyon yanıtı
